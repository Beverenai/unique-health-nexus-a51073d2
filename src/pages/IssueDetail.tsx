...
const IssueDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#F8F8FC] px-6 pb-20 pt-6">
      <Button 
        variant="ghost" 
      ...
      <div className="flex items-center mb-4">
        <div className="h-2 bg-[#9b87f5] rounded-full" style={{ width: `${issue.load}%` }}></div>
      ...
      <Tabs 
        ...
        className="mb-6"
      >
        <TabsList className="grid grid-cols-2 mb-4 bg-white/70 backdrop-blur-sm">
        ...
        <TabsContent value="recommendations">
          ...
          <div className="mb-8">
            ...
            <Card className="mb-4 bg-white/70 backdrop-blur-sm border-gray-100/20">
              <CardContent className="pt-6">
